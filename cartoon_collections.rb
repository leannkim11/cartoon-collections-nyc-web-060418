# def roll_call_dwarves(dwarf_arr)# code an argument here
#   dwarf_arr.each_with_index{|index, dwarf| puts "#{index} #{dwarf}"
# end
# 
# def summon_captain_planet(cp_arr)# code an argument here
#   
# end
# 
